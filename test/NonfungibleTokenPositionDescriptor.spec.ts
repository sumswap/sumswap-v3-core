...
import { SummaSwapV3NFTDescriptor, MockTimeSummaSwapV3Manager, TestERC20 } from '../typechain'
...
describe('SummaSwapV3NFTDescriptor', () => {
  let wallets: Wallet[]

  const nftPositionDescriptorCompleteFixture: Fixture<{
    nftPositionDescriptor: SummaSwapV3NFTDescriptor
  ...
  let nftPositionDescriptor: SummaSwapV3NFTDescriptor
