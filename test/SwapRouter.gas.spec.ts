...
import { ISummaSwapV3Pool, IWETH9, MockTimeSwapRouter,TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [ISummaSwapV3Pool, ISummaSwapV3Pool, ISummaSwapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, ISummaSwapV3PoolABI, wallet)) as [
      ISummaSwapV3Pool,
      ISummaSwapV3Pool,
      ISummaSwapV3Pool
    ]
  ...
  let pools: [ISummaSwapV3Pool, ISummaSwapV3Pool, ISummaSwapV3Pool]
